...
public class MainActivity extends ActionBarActivity {
	...
	private static class MHandler extends Handler {
		private final WeakReference<MainActivity> activityMain;

		public MHandler(MainActivity activity) {
			activityMain = new WeakReference<MainActivity>(activity);
		}

		public void handleMessage(Message msg) {
			MainActivity activity = activityMain.get();
			if (activity != null) {
				switch (msg.what) {
	...
	public static class MainFragment extends Fragment implements
		...
		public void onStart() {
			super.onStart();
			mHandler = new MHandler((MainActivity) this.getActivity());
		}
		...
		private void startRecording() {
			try {
				...
				// mRecorder.start();
				mHandler.sendEmptyMessage(MainActivity.BUTTON_REC_IS_DISSABLED);
		...
		private void stopRecording() {
			...
			mHandler.sendEmptyMessage(MainActivity.BUTTON_REC_IS_ENABLED);
		}
